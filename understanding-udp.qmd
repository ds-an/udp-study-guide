...
#| echo: false
#| results: "asis"
exams2forms(c("quizzes/part1.Rmd"))
```
...
`r exams2forms::forms_schoice( c("GitLab", "Terraform", "MLflow", "New Relic"), c(TRUE, FALSE, FALSE, FALSE), display = "dropdown" )`

3. AWS CodeGuru's primary function is:

`r exams2forms::forms_schoice( c("Code optimization", "Cloud provisioning", "Data visualization", "Network security"), c(TRUE, FALSE, FALSE, FALSE), display = "dropdown" )`

4. Vendor agnosticism primarily prevents:

`r exams2forms::forms_schoice( c("Cloud lock-in", "Code errors", "Data breaches", "AI bias"), c(TRUE, FALSE, FALSE, FALSE), display = "dropdown" )`

5. The main purpose of Terraform is:
...
6. Kubeflow specializes in managing workflows for:

`r exams2forms::forms_schoice( c("Kubernetes", "AWS Lambda", "Azure Functions", "Google Cloud Run"), c(TRUE, FALSE, FALSE, FALSE), display = "dropdown" )`

7. Shift-left security means detecting vulnerabilities early (True/False)

`r exams2forms::forms_schoice( c("True", "False"), c(TRUE, FALSE), display = "dropdown" )`

8. GitHub Codespaces is best described as a:

`r exams2forms::forms_schoice( c("Cloud IDE", "ML platform", "Data lake", "Monitoring tool"), c(TRUE, FALSE, FALSE, FALSE), display = "dropdown" )`

9. Azure DevOps achieved what percentage reduction in deployment cycles?

`r exams2forms::forms_num(40)`

10. New Relic's core capability is:
...
<!-- Warning message: -->
<!-- In total_correct() : -->
<!--   The function webexercises::total_correct() is deprecated. Use sections with the class 'webex-check' to set up self-checking mini-quizzes with total correct. -->
